	...
	Assert.assertEquals("Bonjour, c'est shivanjali", p);
	 ...
	 @Test(priority=2)
		public void suggestionBox() {
			Select l = new Select(webdriver.findElement(By.id("t_sl")));
			l.selectByValue("sm");
			Select k = new Select(webdriver.findElement(By.id("t_sl")));
			k.selectByValue("ru");
			String g=webdriver.findElement(By.className("ttl_histbtn")).getAttribute("value");
